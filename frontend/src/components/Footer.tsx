        ...
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    <a href="https://www.linkedin.com/in/muktinath-rajbanshi-6b3b31256" target="_blank" rel="noreferrer">
                        <LinkedinIcon className="size-5 hover:text-pink-500" />
                    </a>
                    <a href="https://x.com/@muktinathrajba2" target="_blank" rel="noreferrer">
                        <TwitterIcon className="size-5 hover:text-pink-500" />
                    </a>
                    <a href="https://www.youtube.com/@muktinathrajbanshi219?sub_confirmation=1" target="_blank" rel="noreferrer">
                        <YoutubeIcon className="size-6 hover:text-pink-500" />
                    </a>
                </div>
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} 
                    <a href="https://prebuiltui.com?utm_source=pixels"> AI Thumbnail - Muktinath Tech</a></p>
            </motion.div>
        </footer>
    );
}