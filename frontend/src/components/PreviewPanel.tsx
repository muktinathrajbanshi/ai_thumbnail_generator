...
const PreviewPanel = ({thumbnail, isLoading, aspectRatio} : {thumbnail: IThumbnail | null, 
    isLoading: boolean; aspectRatio: AspectRatio}) => {
      ...
      <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
        ...
        {!isLoading && thumbnail?.image_url && (
            <div className="group relative h-full w-full">
                ...
                <div className="absolute inset-0 flex item-end justify-center
                 bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
                    ...
                    bg-white/30 ring-2 ring-white/40 backdrop-blur hover:scale-105
                    active:scale-95">
